...
public class ProductServiceImpl implements IProductService {
    ...
    public ServerResponse saveOrUpdateProduct(Product product) {
        ...
        return ServerResponse.createBySuccessMessage("Invalid parameter");
    }
    ...
    public ServerResponse<String> setSaleStatus(Integer productId, Integer status) {
        ...
        if(rowCount > 0) {
            return ServerResponse.createBySuccess("Set product status successfully");
        }

        return ServerResponse.createBySuccess("Set product status unsuccessfully");
    }
